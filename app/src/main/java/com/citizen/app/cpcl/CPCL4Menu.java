...
import com.citizen.app.assist.CPCLSample4;
...
public class CPCL4Menu extends ListActivity
{	
		...
		.setPositiveButton("OK", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int whichButton) 
			{
				try
				{
					...
					Toast toast = Toast.makeText(CPCL4Menu.this, temp, Toast.LENGTH_LONG);
					toast.show();
					...
					switch(arg2)
					{
						...
						case 8:
							...
							case CPCLConst.CMP_STS_CPCL_NORMAL:
								tst = Toast.makeText(CPCL4Menu.this, "Printing success", Toast.LENGTH_LONG);
								break;
							case CPCLConst.CMP_STS_CPCL_COVER_OPEN:
								tst = Toast.makeText(CPCL4Menu.this, "Cover Open", Toast.LENGTH_LONG);
								break;
							case CPCLConst.CMP_STS_CPCL_PAPER_EMPTY:
								tst = Toast.makeText(CPCL4Menu.this, "Paper Empty", Toast.LENGTH_LONG);
								break;
							case CPCLConst.CMP_STS_CPCL_TIMEOUT:
								tst = Toast.makeText(CPCL4Menu.this, "No response\r\nCheck the printer", Toast.LENGTH_LONG);
								break;
							default:
								tst = Toast.makeText(CPCL4Menu.this, "Unknown Error", Toast.LENGTH_LONG);
								break;
							}
							tst.show();
							break;	
					...
					if(arg2 != 8)
					{
						...
						while(!(temp = sample.statusCheck()).equals("Normal"))
						{
							...
							toast = Toast.makeText(CPCL4Menu.this, i+" "+temp, Toast.LENGTH_LONG);
							toast.show();
							i++;
							Thread.sleep(2000);
						}
